      ...
      <header className="bg-white/90 backdrop-blur-md shadow-lg border-b border-gray-100 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <Link href="/create-event" className="text-blue-600 font-semibold">
              Create Event
            </Link>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-600">Bring people together with your unique event</p>
          </div>
            ...
            {currentStep === 1 && (
              <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
                ...
                <div className="space-y-6">
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-3">Event Title *</label>
                    <input
                      type="text"
                      name="title"
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-3">Event Description</label>
                    <textarea
                      name="description"
